...
public class DebtIncomeMapper 
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		String[] fields = line.substring(1, line.length()-1).split("\",\"");
		if ((fields.length==47) && 
			fields[14].equals("One-to-four family dwelling (other than manufactured housing)") && 
			fields[19].equals("Home purchase") && 
			fields[20].equals("Secured by a first lien") && 
			fields[46].equals("Loan originated")) { 
